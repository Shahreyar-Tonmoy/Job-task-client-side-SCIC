        ...
        <section id='ContactId' className=" py-20 lg:py-[50px] overflow-hidden relative z-10">
            ...
            <div className="container">
                <div className="flex lg:mx-20 flex-wrap lg:justify-around ">
                    ...
                    data-aos-duration="1500" className="w-full lg:w-1/2 xl:w-6/12 px-4">
                        <div className="max-w-[570px] border-stone-400 bg-slate-200 rounded-xl py-10  mb-12 lg:mb-0">
            ...
            ">
                    ...
                    <div data-aos="fade-left"
                        ...
                        <div className="shadow-2xl border-stone-400 bg-slate-200 relative rounded-lg p-8 sm:p-12 ">
                  ...
                  border border-stone-400 bg-slate-200
                  outline-none 
